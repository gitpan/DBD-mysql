...
=item B<connect>
    ...
    $dsn = "DBI:mysql:$database:$hostname:$port";
    $dsn = "DBI:mysql:$database:$hostname:$port;mysql_compression=1";
...
As of MySQL 3.22.3, a new feature is supported: If you finish your DSN
with ";mysql_compression=1", then the communication between client and
